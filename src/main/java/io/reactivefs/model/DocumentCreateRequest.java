...
/**
 * Defines the file create request that contains the payload along with the owners of the document.
 *
 ...
 */
public record DocumentCreateRequest(String organizationId, String userId, String fileName, String payload) {
}